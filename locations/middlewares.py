"""
Middleware copied from https://github.com/clemfromspace/scrapy-selenium (develop branch).

Reasons:
  1. PyPI package is outdated (missing Remote WebDriver support);
  2. GitHub code still needs fixes for browser options.

Keeping it locally reduces maintenance issues.
"""
